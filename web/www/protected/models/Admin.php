...
class Admin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('admin_name, password, last_login', 'required'),
			array('is_superadmin', 'numerical', 'integerOnly'=>true),
			array('admin_name, password', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_admin, admin_name, password, is_superadmin, last_login', 'safe', 'on'=>'search'),
		);
	}
